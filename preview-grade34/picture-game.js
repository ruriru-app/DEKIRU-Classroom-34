window.PictureGame = (() => {
  function heading(title) {
    ...
    return `<header class="game-heading"><button class="back-button" data-feature="close" aria-label="戻る"><img src="assets/ui/originals/戻る.svg" alt=""></button><h1>${title}</h1><button class="fullscreen-button" data-fullscreen aria-label="全画面表示切り替え">⛶</button></header>`;
  }
